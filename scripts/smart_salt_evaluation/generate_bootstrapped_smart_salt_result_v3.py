# /opt/spark/current20/bin/spark-submit generate_bootstrapped_smart_salt_result_v3.py  --account trivago --group_size 5percent --run_date 2019-02-28 --source_table_name trivago_smart_salt_table_v2_20190201_ntrials_10000_group_size_5percent  --number_of_salts 100 2>/dev/null
...
def main():
    ...
    table_name = ('_'.join([args.account, 'smart_salt_bootstrapping_v3',
